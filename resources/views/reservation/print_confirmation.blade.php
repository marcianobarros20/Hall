...
<div class="panel-body">
  <div class="row">
    <div class="col-6">
      ...
      {{ $reservation_details->rooms->rooms_address->address_line_1 }}<br>{{ $reservation_details->rooms->rooms_address->city.', '.$reservation_details->rooms->rooms_address->state.' '.$reservation_details->rooms->rooms_address->postal_code }}<br>{{ $reservation_details->rooms->rooms_address->country_name }}<br>
    </div>
