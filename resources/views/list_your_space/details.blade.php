<div class="manage-listing-content-container" id="js-manage-listing-content-container">
    ...
    <div class="row row-space-4 language-tabs-container">
      ...
      <!-- <div class="col-3 text-right add-language-container">
        <a href="manage-listing/7232267/details#" class="add-first-language" rel="tooltip" title="Write a title and description for this listing in another language">
          <i class="icon icon-add"></i> Add Language
        </a>
      </div> -->
    </div>
