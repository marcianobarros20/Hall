...
<div id="js-additional-guests" class="row-space-3 js-tooltip-trigger">
  ...
  <div data-checkbox-id="price_for_extra_person_checkbox" ng-show="extra_person_checkbox" ng-cloak>
    <div class="row row-space-1 row-condensed">
      <div class="col-4">
        <div class="input-addon">
          <span class="input-prefix">{{ $result->rooms_price->currency->original_symbol }}</span>
          <input type="text" data-extras="true" value="{{ ($result->rooms_price->original_additional_guest == 0) ? '' : $result->rooms_price->original_additional_guest }}" id="price-extra_person" name="additional_guest" class="autosubmit-text input-stem input-large" data-saving="additional-saving">
        </div>
      </div>
