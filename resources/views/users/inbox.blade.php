    ...
    <div class="col-sm-9 col-md-3 thread-author">
      <div class="row row-table">
        <div class="thread-avatar col-md-5">
          <a href="{{ url('users/show/')}}/@{{ all.user_details.id  }}"><img height="50" width="50" title="@{{ all.user_details.first_name }}" src="@{{ all.user_details.profile_picture.src }}" class="media-round media-photo" alt="@{{ all.user_details.first_name }}"></a>
        </div>
