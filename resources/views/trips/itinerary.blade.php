...
<div class="row">
<div class="col-9">
<h2 class="text-center-on-sm">{{ trans('messages.your_trips.you_are_gonna') }} {{ $reservation_details->rooms->rooms_address->city }}!</h2>
...
<div class="show-md">
<div class="hide-print">
<img src="{{ url('images/'.$reservation_details->rooms->photo_name) }}" class="media-photo media-photo-block img-responsive listing-large-photo">
</div>
</div>
...
<div class="col-9">
<div>{{ $reservation_details->rooms->rooms_address->address_line_1 }}<br>{{ $reservation_details->rooms->rooms_address->city }}, {{ $reservation_details->rooms->rooms_address->state }} {{ $reservation_details->rooms->rooms_address->postal_code }}<br>{{ $reservation_details->rooms->rooms_address->country_name }}<br>
</div>
...
<img src="{{ $reservation_details->rooms->users->profile_picture->header_src }}" alt="{{ $reservation_details->rooms->users->full_name }}" width="50" height="50" class="media-photo media-round pull-right">
</a>
</div>
</div>
</div>
