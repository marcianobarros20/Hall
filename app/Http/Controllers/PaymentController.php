...
class PaymentController extends Controller 
{
    ...
    public function index(Request $request)
    {
        ...
        $data['price_eur']        = $this->payment_helper->currency_convert($data['result']->rooms_price->code, 'EUR', $data['price_list']->total);

        $data['price_rate']       = $this->payment_helper->currency_rate($data['result']->rooms_price->currency_code, 'EUR');
	...
	public function create_booking(Request $request)
	{
        ...
        $amount         = $this->payment_helper->currency_convert($request->currency, 'EUR', $price_list->total);
