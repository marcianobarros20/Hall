...
class RoomsController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        $rooms->user_id       = Auth::user()->user()->id;
    ...
    public function update_price(Request $request)
    {
        ...
        return json_encode(['success'=>'true', 'currency_symbol' => $price->currency->original_symbol, 'steps_count' => $price->steps_count]);
    }
    ...
    public function contact_request(Request $request, EmailController $email_controller)
    {
        ...
        $message->user_to        = Rooms::find($request->id)->first()->user_id;
